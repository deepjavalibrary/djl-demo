...
libraryDependencies += "ai.djl" % "api" % "0.18.0"
libraryDependencies += "ai.djl.pytorch" % "pytorch-engine" % "0.18.0"

// PyTorch JNI offline distribution package
libraryDependencies += "ai.djl.pytorch" % "pytorch-jni" % "0.18.0"
...
libraryDependencies += "ai.djl.pytorch" % "pytorch-model-zoo" % "0.18.0"
