  ...
  <div class="app-container">
    <el-form ref="form" :model="form" label-width="120">
      ...
      <el-row>
        ...
        <el-col :span="5">
          <el-form-item label="">
            <textarea v-model="form.result1" style="margin-left:50px;font-size:14px;border:none;" rows="12" cols="50" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-form-item>
      ...
      <el-row>
        ...
        <el-col :span="5">
          <el-form-item label="">
            <textarea v-model="form.result2" style="margin-left:50px;font-size:14px;border:none;" rows="12" cols="50" />
          </el-form-item>
        </el-col>
      </el-row>
